...
# Initialize an empty DataFrame to hold all filtered results
...
def filter_and_combine(df, time_ranges, combined_df):
    for time_range in time_ranges:
        ...
        # Append the filtered results to the combined DataFrame
        combined_df = pd.concat([combined_df, filtered_df], ignore_index=True)
    return combined_df

folder_name = 'Whole_excels'
...
if scenario == 'bike2crosswalk':
    ...
    # Filter and combine results from each DataFrame and their respective time ranges
    combined_df = filter_and_combine(df1, time_ranges1, combined_df)
    combined_df = filter_and_combine(df2, time_ranges2, combined_df)
    ...
    combined_df = filter_and_combine(df6, time_ranges6, combined_df)
    ...
    combined_df = filter_and_combine(df3_arman, mar_16_arman, combined_df)
    combined_df = filter_and_combine(df4_arman, mar_18_arman, combined_df)
    combined_df = filter_and_combine(df5_arman, mar_19_arman, combined_df)
    combined_df = filter_and_combine(df6_arman, apr_1_arman, combined_df)
    combined_df = filter_and_combine(df7_arman, mar_25_arman, combined_df)
    combined_df = filter_and_combine(df8_arman, mar_27_arman, combined_df)
    combined_df = filter_and_combine(df9_arman, mar_30_arman, combined_df)
    combined_df = filter_and_combine(df10_arman, apr_4_arman, combined_df)
    combined_df.to_csv('Whole_excels/bike2crosswalk.csv', index=False)
...
if scenario == 'downhill':
    ...
    combined_df = filter_and_combine(df9_arman, mar_30_arman, combined_df)
    combined_df = filter_and_combine(df10_arman, apr_4_arman, combined_df)
    combined_df.to_csv('Whole_excels/downhill.csv', index=False)
...
if scenario == 'intersection':
    ...
    combined_df = filter_and_combine(df9_arman, mar_30_arman, combined_df)
    combined_df = filter_and_combine(df10_arman, apr_4_arman, combined_df)
    combined_df.to_csv('Whole_excels/intersection.csv', index=False)
...
if scenario == 'road_fixtures':
    ...
    combined_df = filter_and_combine(df9_arman, mar_30_arman, combined_df)
    combined_df = filter_and_combine(df10_arman, apr_4_arman, combined_df)
    combined_df.to_csv('Whole_excels/road_fixtures.csv', index=False)
...
if scenario == 'road2bikelane':
    ...
    combined_df = filter_and_combine(df9_arman, mar_30_arman, combined_df)
    combined_df = filter_and_combine(df10_arman, apr_4_arman, combined_df)
    combined_df.to_csv('Whole_excels/road2bikelane.csv', index=False)
...
if scenario == 'close_proximity':
    ...
    combined_df = filter_and_combine(df9_arman, mar_30_arman, combined_df)
    combined_df = filter_and_combine(df10_arman, apr_4_arman, combined_df)
    combined_df.to_csv('Whole_excels/close_proximity.csv', index=False)
...
if scenario == 'occupied_crosswalk':
    ...
    combined_df = filter_and_combine(df8_arman, mar_27_arman, combined_df)
    combined_df = filter_and_combine(df9_arman, mar_30_arman, combined_df)
    combined_df.to_csv('Whole_excels/occupied_crosswalk.csv', index=False)
...
if scenario == 'passing_bus':
    ...
    combined_df = filter_and_combine(df9_arman, mar_30_arman, combined_df)
    combined_df = filter_and_combine(df10_arman, apr_4_arman, combined_df)
    combined_df.to_csv('Whole_excels/passing_bus.csv', index=False)
...
if scenario == 'passing_pedestrian':
    ...
    combined_df = filter_and_combine(df9_arman, mar_30_arman, combined_df)
    combined_df = filter_and_combine(df10_arman, apr_4_arman, combined_df)
    combined_df.to_csv('Whole_excels/passing_pedestrian.csv', index=False)