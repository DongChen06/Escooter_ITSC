...
if senario == 'sidewalk':
    combined_df.to_excel('Whole_excels/sidewalk.xlsx', index=False, engine='openpyxl')
if senario == 'walkways':
    combined_df.to_excel('Whole_excels/walkways.xlsx', index=False, engine='openpyxl')
if senario == 'roadwbikelane':
    combined_df.to_csv('Whole_excels/roadwbikelane.csv', index=False)
if senario == 'roadwobikelane':
    combined_df.to_csv('Whole_excels/roadwobikelane.csv', index=False)
...
if senario == 'roadwbikelane':
    ...
    combined_df = filter_and_combine(df_dec_11_arik, dec_11_arik, combined_df)
    combined_df = filter_and_combine(df_dec_14_arik, dec_14_arik, combined_df)
    combined_df = filter_and_combine(df_dec_20_arik, dec_20_arik, combined_df)
    combined_df = filter_and_combine(df_feb_13_arik, feb_13_arik, combined_df)
    combined_df = filter_and_combine(df_feb_16_arik, feb_16_arik, combined_df)
    combined_df = filter_and_combine(df_jan_25_arik, jan_25_arik, combined_df)
    ...
    combined_df = filter_and_combine(df7, time_ranges7, combined_df)
    combined_df = filter_and_combine(df8, time_ranges8, combined_df)
    combined_df = filter_and_combine(df9, time_ranges9, combined_df)
    combined_df = filter_and_combine(df10, time_ranges10, combined_df)
    combined_df.to_csv('Whole_excels/roadwbikelane.csv', index=False)
